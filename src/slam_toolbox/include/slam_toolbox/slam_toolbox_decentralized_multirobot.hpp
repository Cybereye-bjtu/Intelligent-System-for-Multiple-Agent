...
protected:
  ...
  bool transformPeerPoseToHost(const std::string & source_ns, Pose2 & pose) const;
  ...
  std::string host_ns_;
  bool publish_peer_transforms_;
  bool use_known_initial_poses_;
  std::map<std::string, Pose2> initial_poses_;
};
